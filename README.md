...
* [skills/secure-code-game](https://github.com/skills/secure-code-game) ⭐ 2,815 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-01 - Hands-on security training game where you identify and fix vulnerabilities in real code across multiple programming languages
* [skills/introduction-to-codeql](https://github.com/skills/introduction-to-codeql) ⭐ 145 | 🐛 2 | 🌐 Python | 📅 2026-06-24 - Interactive GitHub Skills course teaching how to enable code scanning, review alerts, and fix vulnerabilities using CodeQL
...
* [Homebrew/homebrew-cask](https://github.com/Homebrew/homebrew-cask/blob/master/Casks/c/codeql.rb) ⭐ 22,179 | 🐛 26 | 🌐 Ruby | 📅 2026-09-01 - Homebrew cask to install the CodeQL CLI `brew install --cask codeql`
...
* [advanced-security/grab\_ql](https://github.com/advanced-security/grab_ql) ⭐ 10 | 🐛 10 | 🌐 Python | 📅 2026-03-26 - Grab some/all of CodeQL CLI binary, QL library, VSCode starter workspace, VSCode and VSCode QL extension
...
* [github/gh-codeql](https://github.com/github/gh-codeql) ⭐ 43 | 🐛 4 | 🌐 Shell | 📅 2026-08-10 - GitHub CLI extension for working with CodeQL
...
* [trailofbits/mrva](https://github.com/trailofbits/mrva) ⭐ 17 | 🐛 3 | 🌐 Python | 📅 2026-07-15 - Terminal-first approach to CodeQL multi-repo variant analysis
...
* [psastras/sarif-rs-sarif-fmt](https://github.com/psastras/sarif-rs/tree/main/sarif-fmt) ⭐ 135 | 🐛 22 | 🌐 Rust | 📅 2026-08-31 - This crate provides a command line tool to pretty print SARIF files to easy human readable output.
...
* [GitHubSecurityLab/seclab-taskflow-agent](https://github.com/GitHubSecurityLab/seclab-taskflow-agent) ⭐ 230 | 🐛 24 | 🌐 Python | 📅 2026-08-21 - The GitHub Security Lab Taskflow Agent is an MCP enabled multi-Agent framework. See the [CVE-2023-2283](https://github.com/GitHubSecurityLab/seclab-taskflow-agent/blob/main/examples/taskflows/CVE-2023-2283.yaml) ⭐ 230 | 🐛 24 | 🌐 Python | 📅 2026-08-21 taskflow for an example of how to have an Agent review C code using a CodeQL database ([demo video](https://www.youtube.com/watch?v=eRSPSVW8RMo)).
  * [GitHubSecurityLab/seclab-taskflows](https://github.com/GitHubSecurityLab/seclab-taskflows) ⭐ 76 | 🐛 8 | 🌐 Python | 📅 2026-08-26 - Example taskflows to use with the GitHub Security Lab Taskflow Agent Framework. Intended to be an easy-to-copy template for anybody who would like to publish their own suite of taskflows.
...
* [advanced-security/codeql-development-template](https://github.com/advanced-security/codeql-development-template) ⭐ 11 | 🐛 8 | 🌐 CodeQL | 📅 2026-08-31 - Copilot-native repository template for CodeQL query development. Lowering the barrier to entry for CodeQL development through natural language and GitHub Copilot. A GitHub repository template for building custom CodeQL queries with AI assistance. This template provides a structured environment with prompts, instructions, and workflows designed to guide GitHub Copilot Coding Agent through the complete CodeQL development lifecycle.
...
* [advanced-security/sample-pipeline-files](https://github.com/advanced-security/sample-codeql-pipeline-config) ⭐ 22 | 🐛 3 | 📅 2026-06-09 - This repository contains pipeline files for various CI/CD systems (AWS CodeBuild, Azure Devops, CircleCI, DroneCI, Jenkins, Tekton, Travis), illustrating how to integrate the CodeQL CLI Bundle for Automated Code Scanning

### CodeQL GitHub Actions Helpers

* [badge-generator](https://github.com/MichaelCurrin/badge-generator) ⭐ 490 | 🐛 79 | 🌐 TypeScript | 📅 2026-06-22 - [![CodeQL](https://github.com/MichaelCurrin/badge-generator/workflows/CodeQL/badge.svg)](https://github.com/MichaelCurrin/badge-generator/actions?query=workflow%3ACodeQL "Code quality workflow status") ⭐ 490 | 🐛 79 | 🌐 TypeScript | 📅 2026-06-22 Magically generate Markdown badges for your docs 🛡️ 🦡 🧙
...
* [advanced-security/dismiss-alerts](https://github.com/advanced-security/dismiss-alerts) ⭐ 23 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-11 - Dismisses GitHub Code Scanning alerts from `//codeql[supress reason]` style comments on the default branch
...
* [advanced-security/monorepo-code-scanning-action](https://github.com/advanced-security/monorepo-code-scanning-action) ⭐ 16 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-17 - Focus SAST scans (with CodeQL) on just the changed parts of your monorepo, split up as you define
...
* [advanced-security/sarif-toolkit](https://github.com/advanced-security/sarif-toolkit/blob/main/submodules/) ⭐ 4 | 🐛 8 | 🌐 Python | 📅 2026-08-26 - Allows users to split up SARIF files that use submodules into multiple SARIF files that are then published to there appropriate repositories.
...
* [advanced-security/codeql-extractor-action](https://github.com/advanced-security/codeql-extractor-action) ⭐ 2 | 🐛 8 | 🌐 Rust | 📅 2026-08-26 - An Action that allows you to specify a CodeQL extractor to be used in your workflows as an author of an Extractor.
...
* [advanced-security/sample-javascript-monorepo](https://github.com/advanced-security/sample-javascript-monorepo) ⭐ 0 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-28 - Detached fork of babel/babel to use as a TypeScript monorepo sample with 150+ packages using the [monorepo-code-scanning-action](https://github.com/advanced-security/monorepo-code-scanning-action) ⭐ 16 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-17

### CodeQL Enforcement

* [advanced-security-enforcer](https://github.com/zkoppert/advanced-security-enforcer) ⚠️ Archived - A GitHub action for organizations that enables advanced security code scanning on all new repos
* [codeql-selective-analysis](https://github.com/octodemo/codeql-selective-analysis) ⭐ 3 | 🐛 2 | 🌐 JavaScript | 📅 2023-08-18 - Make CodeQL a required status check for Pull Requests, but to skip the analysis in the case that only a certain subset of files are modified
...
* [github/codeql-coding-standards](https://github.com/github/codeql-coding-standards) ⭐ 225 | 🐛 137 | 🌐 CodeQL | 📅 2026-08-28 - This repository contains CodeQL queries and libraries which support various Coding Standards. (AUTOSAR C++, CERT-C++,CERT C, MISRA C)
* [GitHubSecurityLab/CodeQL-Community-Packs](https://github.com/GitHubSecurityLab/CodeQL-Community-Packs) ⭐ 217 | 🐛 14 | 🌐 Java | 📅 2026-08-31 - Collection of community-driven CodeQL query, library and extension [packages](https://github.com/orgs/githubsecuritylab/packages). Blog: [Announcing CodeQL Community Packs](https://github.blog/security/vulnerability-research/announcing-codeql-community-packs/)
* [trailofbits/codeql-queries](https://github.com/trailofbits/codeql-queries) ⭐ 176 | 🐛 9 | 🌐 CodeQL | 📅 2026-07-13 - CodeQL queries and [packs](https://github.com/orgs/trailofbits/packages?ecosystem=all\&q=repo%3Atrailofbits%2Fcodeql-queries) developed by Trail of Bits
...
* [rvermeulen/codeql-bundle](https://github.com/rvermeulen/codeql-bundle) ⭐ 15 | 🐛 10 | 🌐 Python | 📅 2026-08-28 - CLI to build a custom CodeQL bundle
...
* [advanced-security/codeql-qtil](https://github.com/advanced-security/codeql-qtil) ⭐ 4 | 🐛 11 | 🌐 CodeQL | 📅 2026-03-21 - A library with a wide variety of handy CodeQL utilities, from simple to complex.

### Custom Modeling

* [GitHubSecurityLab/CodeQL-Community-Packs](https://github.com/GitHubSecurityLab/CodeQL-Community-Packs/blob/main/configs/default.yml#L19-L25) ⭐ 217 | 🐛 14 | 🌐 Java | 📅 2026-08-31 - GitHub Security Lab model packs
...
* [advanced-security/codeql-coding-standards-bundle-releases](https://github.com/advanced-security/codeql-coding-standards-bundle-releases) ⭐ 6 | 🐛 0 | 📅 2022-06-24 - CodeQL bundles containing the CodeQL Coding Standards queries
...
* [codeql/actions](https://github.com/github/codeql/actions/workflows/query-list.yml?query=branch%3Acodeql-cli%2Flatest) ⭐ 10,039 | 🐛 1,470 | 🌐 CodeQL | 📅 2026-09-01 - GitHub full built-in CodeQL query list - download the attached `code-scanning-query-list.csv` artifact.
...
* [advanced-security/codeql-extractor-iac](https://github.com/advanced-security/codeql-extractor-iac) ⭐ 62 | 🐛 20 | 🌐 CodeQL | 📅 2026-08-29 - CodeQL Extractors, Library, and Queries for Infrastructure as Code ( Terraform / HCL, JSON, YAML, Container files, Bicep )
* [CoinFabrik/CyScout](https://github.com/CoinFabrik/CyScout/tree/main/solidity/codeql) ⭐ 56 | 🐛 1 | 🌐 CodeQL | 📅 2024-10-25 - CyScout Solidity Extractor: Run queries and detect vulnerabilities in your smart contracts using CodeQL-Solidity
* [microsoft/codeql](https://github.com/microsoft/codeql/blob/main/powershell/README.md) ⭐ 27 | 🐛 41 | 🌐 C# | 📅 2026-08-26 - Microsoft CodeQL Powershell extractor, sample queries, and tools
...
* [advanced-security/codeql-sap-js](https://github.com/advanced-security/codeql-sap-js) ⭐ 8 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-28 - CodeQL extractor/queries/models for SAP JavaScript frameworks CAP, UI5 and XSJS
...
* [advanced-security/codeql-extractor-action](https://github.com/advanced-security/codeql-extractor-action) ⭐ 2 | 🐛 8 | 🌐 Rust | 📅 2026-08-26 - specify a CodeQL extractor to be used in your workflows as an author of an Extractor.

## Troubleshooting

* [github/codeql-coding-standards](https://github.com/github/codeql-coding-standards/blob/main/docs/user_manual.md#hazard-and-risk-analysis) ⭐ 225 | 🐛 137 | 🌐 CodeQL | 📅 2026-08-28 - CodeQL Coding Standards - Hazard and risk analysis
* [advanced-security/advanced-security-material](https://github.com/advanced-security/advanced-security-material/tree/main/troubleshooting/codeql-builds) ⭐ 80 | 🐛 10 | 🌐 Shell | 📅 2026-08-29 - CodeQL Build Failure Troubleshooting
* [advanced-security/advanced-security-material](https://github.com/advanced-security/advanced-security-material/blob/main/troubleshooting/sarif-upload/troubleshooting.md) ⭐ 80 | 🐛 10 | 🌐 Shell | 📅 2026-08-29 - GitHub SARIF Upload Troubleshooting
...
[What is an awesome list?](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 502,015 | 🐛 105 | 📅 2026-08-21
