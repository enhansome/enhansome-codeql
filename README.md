...
* [Homebrew/homebrew-cask](https://github.com/Homebrew/homebrew-cask/blob/master/Casks/c/codeql.rb) ⭐ 22,176 | 🐛 23 | 🌐 Ruby | 📅 2026-08-29 - Homebrew cask to install the CodeQL CLI `brew install --cask codeql`
...
* [trailofbits/codeql-queries](https://github.com/trailofbits/codeql-queries) ⭐ 175 | 🐛 9 | 🌐 CodeQL | 📅 2026-07-13 - CodeQL queries and [packs](https://github.com/orgs/trailofbits/packages?ecosystem=all\&q=repo%3Atrailofbits%2Fcodeql-queries) developed by Trail of Bits
...
* [codeql/actions](https://github.com/github/codeql/actions/workflows/query-list.yml?query=branch%3Acodeql-cli%2Flatest) ⭐ 10,023 | 🐛 1,464 | 🌐 CodeQL | 📅 2026-08-28 - GitHub full built-in CodeQL query list - download the attached `code-scanning-query-list.csv` artifact.
...
[What is an awesome list?](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 500,897 | 🐛 105 | 📅 2026-08-21
