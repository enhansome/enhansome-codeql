...
* [skills/secure-code-game](https://github.com/skills/secure-code-game) ⭐ 2,822 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-03 - Hands-on security training game where you identify and fix vulnerabilities in real code across multiple programming languages
* [skills/introduction-to-codeql](https://github.com/skills/introduction-to-codeql) ⭐ 149 | 🐛 3 | 🌐 Python | 📅 2026-06-24 - Interactive GitHub Skills course teaching how to enable code scanning, review alerts, and fix vulnerabilities using CodeQL
...
* [Homebrew/homebrew-cask](https://github.com/Homebrew/homebrew-cask/blob/master/Casks/c/codeql.rb) ⭐ 22,192 | 🐛 26 | 🌐 Ruby | 📅 2026-09-08 - Homebrew cask to install the CodeQL CLI `brew install --cask codeql`
...
* [codeql/actions](https://github.com/github/codeql/actions/workflows/query-list.yml?query=branch%3Acodeql-cli%2Flatest) ⭐ 10,063 | 🐛 1,459 | 🌐 CodeQL | 📅 2026-09-08 - GitHub full built-in CodeQL query list - download the attached `code-scanning-query-list.csv` artifact.
...
* [microsoft/codeql](https://github.com/microsoft/codeql/blob/main/powershell/README.md) ⭐ 27 | 🐛 42 | 🌐 C# | 📅 2026-09-08 - Microsoft CodeQL Powershell extractor, sample queries, and tools
...
* [advanced-security/codeql-sap-js](https://github.com/advanced-security/codeql-sap-js) ⭐ 8 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-07 - CodeQL extractor/queries/models for SAP JavaScript frameworks CAP, UI5 and XSJS
...
[What is an awesome list?](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 504,241 | 🐛 106 | 📅 2026-09-02
