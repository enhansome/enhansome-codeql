...
* [skills/secure-code-game](https://github.com/skills/secure-code-game) ⭐ 2,823 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-08 - Hands-on security training game where you identify and fix vulnerabilities in real code across multiple programming languages
* [skills/introduction-to-codeql](https://github.com/skills/introduction-to-codeql) ⭐ 150 | 🐛 3 | 🌐 Python | 📅 2026-06-24 - Interactive GitHub Skills course teaching how to enable code scanning, review alerts, and fix vulnerabilities using CodeQL
* [testing-handbook](https://github.com/trailofbits/testing-handbook) ⭐ 135 | 🐛 21 | 🌐 HTML | 📅 2026-09-07 - The [Trail of Bits Testing Handbook](https://appsec.guide/docs/static-analysis/codeql/) is a resource that guides developers and security professionals in configuring, optimizing, and automating many of the static and dynamic analysis tools used at Trail of Bits.
...
* [Homebrew/homebrew-cask](https://github.com/Homebrew/homebrew-cask/blob/master/Casks/c/codeql.rb) ⭐ 22,195 | 🐛 27 | 🌐 Ruby | 📅 2026-09-09 - Homebrew cask to install the CodeQL CLI `brew install --cask codeql`
...
* [GitHubSecurityLab/seclab-taskflow-agent](https://github.com/GitHubSecurityLab/seclab-taskflow-agent) ⭐ 230 | 🐛 24 | 🌐 Python | 📅 2026-08-21 - The GitHub Security Lab Taskflow Agent is an MCP enabled multi-Agent framework. See the [CVE-2023-2283](https://github.com/GitHubSecurityLab/seclab-taskflow-agent/blob/main/examples/taskflows/CVE-2023-2283.yaml) ⭐ 230 | 🐛 24 | 🌐 Python | 📅 2026-08-21 taskflow for an example of how to have an Agent review C code using a CodeQL database ([demo video](https://www.youtube.com/watch?v=eRSPSVW8RMo)).
  * [GitHubSecurityLab/seclab-taskflows](https://github.com/GitHubSecurityLab/seclab-taskflows) ⭐ 77 | 🐛 8 | 🌐 Python | 📅 2026-09-08 - Example taskflows to use with the GitHub Security Lab Taskflow Agent Framework. Intended to be an easy-to-copy template for anybody who would like to publish their own suite of taskflows.
...
* [badge-generator](https://github.com/MichaelCurrin/badge-generator) ⭐ 489 | 🐛 79 | 🌐 TypeScript | 📅 2026-06-22 - [![CodeQL](https://github.com/MichaelCurrin/badge-generator/workflows/CodeQL/badge.svg)](https://github.com/MichaelCurrin/badge-generator/actions?query=workflow%3ACodeQL "Code quality workflow status") ⭐ 489 | 🐛 79 | 🌐 TypeScript | 📅 2026-06-22 Magically generate Markdown badges for your docs 🛡️ 🦡 🧙
...
* [advanced-security/dismiss-alerts](https://github.com/advanced-security/dismiss-alerts) ⭐ 23 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-08 - Dismisses GitHub Code Scanning alerts from `//codeql[supress reason]` style comments on the default branch
...
* [advanced-security/monorepo-code-scanning-action](https://github.com/advanced-security/monorepo-code-scanning-action) ⭐ 16 | 🐛 16 | 🌐 JavaScript | 📅 2026-07-17 - Focus SAST scans (with CodeQL) on just the changed parts of your monorepo, split up as you define
...
* [advanced-security/sample-javascript-monorepo](https://github.com/advanced-security/sample-javascript-monorepo) ⭐ 0 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-04 - Detached fork of babel/babel to use as a TypeScript monorepo sample with 150+ packages using the [monorepo-code-scanning-action](https://github.com/advanced-security/monorepo-code-scanning-action) ⭐ 16 | 🐛 16 | 🌐 JavaScript | 📅 2026-07-17
...
* [github/codeql-coding-standards](https://github.com/github/codeql-coding-standards) ⭐ 226 | 🐛 137 | 🌐 CodeQL | 📅 2026-09-04 - This repository contains CodeQL queries and libraries which support various Coding Standards. (AUTOSAR C++, CERT-C++,CERT C, MISRA C)
* [GitHubSecurityLab/CodeQL-Community-Packs](https://github.com/GitHubSecurityLab/CodeQL-Community-Packs) ⭐ 217 | 🐛 13 | 🌐 Java | 📅 2026-08-31 - Collection of community-driven CodeQL query, library and extension [packages](https://github.com/orgs/githubsecuritylab/packages). Blog: [Announcing CodeQL Community Packs](https://github.blog/security/vulnerability-research/announcing-codeql-community-packs/)
...
* [GitHubSecurityLab/CodeQL-Community-Packs](https://github.com/GitHubSecurityLab/CodeQL-Community-Packs/blob/main/configs/default.yml#L19-L25) ⭐ 217 | 🐛 13 | 🌐 Java | 📅 2026-08-31 - GitHub Security Lab model packs
...
* [codeql/actions](https://github.com/github/codeql/actions/workflows/query-list.yml?query=branch%3Acodeql-cli%2Flatest) ⭐ 10,070 | 🐛 1,459 | 🌐 CodeQL | 📅 2026-09-09 - GitHub full built-in CodeQL query list - download the attached `code-scanning-query-list.csv` artifact.
...
* [advanced-security/codeql-extractor-iac](https://github.com/advanced-security/codeql-extractor-iac) ⭐ 62 | 🐛 20 | 🌐 CodeQL | 📅 2026-09-04 - CodeQL Extractors, Library, and Queries for Infrastructure as Code ( Terraform / HCL, JSON, YAML, Container files, Bicep )
...
* [microsoft/codeql](https://github.com/microsoft/codeql/blob/main/powershell/README.md) ⭐ 27 | 🐛 41 | 🌐 C# | 📅 2026-09-09 - Microsoft CodeQL Powershell extractor, sample queries, and tools
...
* [advanced-security/codeql-sap-js](https://github.com/advanced-security/codeql-sap-js) ⭐ 8 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-09 - CodeQL extractor/queries/models for SAP JavaScript frameworks CAP, UI5 and XSJS
...
* [github/codeql-coding-standards](https://github.com/github/codeql-coding-standards/blob/main/docs/user_manual.md#hazard-and-risk-analysis) ⭐ 226 | 🐛 137 | 🌐 CodeQL | 📅 2026-09-04 - CodeQL Coding Standards - Hazard and risk analysis
* [advanced-security/advanced-security-material](https://github.com/advanced-security/advanced-security-material/tree/main/troubleshooting/codeql-builds) ⭐ 80 | 🐛 12 | 🌐 Shell | 📅 2026-08-29 - CodeQL Build Failure Troubleshooting
* [advanced-security/advanced-security-material](https://github.com/advanced-security/advanced-security-material/blob/main/troubleshooting/sarif-upload/troubleshooting.md) ⭐ 80 | 🐛 12 | 🌐 Shell | 📅 2026-08-29 - GitHub SARIF Upload Troubleshooting
...
[What is an awesome list?](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 504,517 | 🐛 106 | 📅 2026-09-02
