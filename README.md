...
* [skills/secure-code-game](https://github.com/skills/secure-code-game) ⭐ 2,824 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-13 - Hands-on security training game where you identify and fix vulnerabilities in real code across multiple programming languages
...
* [Homebrew/homebrew-cask](https://github.com/Homebrew/homebrew-cask/blob/master/Casks/c/codeql.rb) ⭐ 22,201 | 🐛 29 | 🌐 Ruby | 📅 2026-09-13 - Homebrew cask to install the CodeQL CLI `brew install --cask codeql`
...
* [psastras/sarif-rs-sarif-fmt](https://github.com/psastras/sarif-rs/tree/main/sarif-fmt) ⭐ 134 | 🐛 22 | 🌐 Rust | 📅 2026-08-31 - This crate provides a command line tool to pretty print SARIF files to easy human readable output.
...
* [badge-generator](https://github.com/MichaelCurrin/badge-generator) ⭐ 490 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-11 - [![CodeQL](https://github.com/MichaelCurrin/badge-generator/workflows/CodeQL/badge.svg)](https://github.com/MichaelCurrin/badge-generator/actions?query=workflow%3ACodeQL "Code quality workflow status") ⭐ 490 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-11 Magically generate Markdown badges for your docs 🛡️ 🦡 🧙
...
* [codeql/actions](https://github.com/github/codeql/actions/workflows/query-list.yml?query=branch%3Acodeql-cli%2Flatest) ⭐ 10,083 | 🐛 1,461 | 🌐 CodeQL | 📅 2026-09-12 - GitHub full built-in CodeQL query list - download the attached `code-scanning-query-list.csv` artifact.
...
[What is an awesome list?](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 505,732 | 🐛 106 | 📅 2026-09-02
